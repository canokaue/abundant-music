...
class SequenceRythmElement extends RythmElement {
    ...
    getNoteRythmElements(module, harmony, harmonyBeatOffset) {
        ...
        while (currentPosition < totalLength) {
            ...
            let beatLength = positionUnitToBeats(elementLength, this.elementLengthUnit, harmonyElement.tsNumerator, harmonyElement.tsDenominator, harmony);
            let rest = false;
...
class SplitRythmElement extends RythmElement {
    ...
    getNoteRythmElements(module, harmony, harmonyBeatOffset) {
        ...
        if (this.autoDetectLengthType) {
            ...
            const possibleLengthTypes = [NoteRythmElementLengthType.NORMAL, NoteRythmElementLengthType.DOT, NoteRythmElementLengthType.TRIPLET];
            ...
            theCurve = {
                getValue: function (m, x) {
                    return that.densityCurveBias +
                        that.densityCurveAmplitude * originalCurve.getValue(m, that.densityCurveFrequency * (x + that.densityCurvePhase));
                }
            };
        }
