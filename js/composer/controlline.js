...
class PrimitiveControlElement extends PositionedControlElement {
    ...
    renderBatch(state) {
        ...
        const startBeatTime = positionUnitToBeats(this.startTime, this.startTimeUnit, harmony.tsNumerator, harmony.tsDenominator, harmony);
        const endBeatTime = positionUnitToBeats(this.endTime, this.endTimeUnit, harmony.tsNumerator, harmony.tsDenominator, harmony);
    ...
    renderAtSlot(slotIndex, startSlot, endSlot, slotFraction, startBeatTime, endBeatTime, state, slotData) {
    }
    renderAtSlots(slotIndices, startSlot, endSlot, slotFractions, startBeatTime, endBeatTime, state, slotData) {
    }
}
...
class CurveControlElement extends PrimitiveControlElement{
    ...
    renderAtSlot(slotIndex, startSlot, endSlot, slotFraction, startBeatTime, endBeatTime, state, slotData) {
        ...
        const rawValue = CurveComputation.prototype.getCurveOrConstantValue(state.module, this.frequencyMultiplier * (x + this.phase), this.theCurve, this.constantValue);
