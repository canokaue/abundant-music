...
class ChromaticOscillationHarmonyGenerator extends HarmonyGenerator {
    constructor(options) {
        ...
        this.startScaleBaseChordRootScaleModeTuples = getValueOrDefault(options, "startScaleBaseChordRootScaleModeTuples", [[this.scaleBaseNote, 0, 0]]);
        this.endScaleBaseChordRootScaleModeTuples = getValueOrDefault(options, "endScaleBaseChordRootScaleModeTuples", [[this.scaleBaseNote, 0, 0]]);
    ...
    getStartStates(result, likelihoods, costs) {
        for (const tuple of this.startScaleBaseChordRootScaleModeTuples) {
