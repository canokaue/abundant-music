...
class ChromaticTransitionHarmonyGenerator extends HarmonyGenerator {
    constructor(options) {
        ...
        this.scaleBaseChordRootScaleModeTuples = getValueOrDefault(options, "scaleBaseChordRootScaleModeTuples", [[this.scaleBaseNote, 0, 0]]);
    ...
    getStartStateIterator() {
        ...
        for (const tuple of this.scaleBaseChordRootScaleModeTuples) {
