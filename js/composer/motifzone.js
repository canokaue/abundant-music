...
class AdaptiveEmbellishMotifZone extends MotifZone {
    ...
    applyMotifZone(elements, module) {
        ...
        for (let i = 0; i < elements.length; i++) {
            ...
            if (doRender && !me.rest) {
                const verticalIndex = getItemFromArrayWithStartEndItems(0, theVerticalIndices, nonRestsCount, nonRestCounter, theStartVerticalIndices, theEndVerticalIndices);
                const verticalOffsetDomain = getItemFromArrayWithStartEndItems(0, this.verticalOffsetDomains, nonRestsCount, nonRestCounter, this.startVerticalOffsetDomains, this.endVerticalOffsetDomains);
                const verticalOffsetLikelihoods = getItemFromArrayWithStartEndItems(0, this.verticalOffsetLikelihoods, nonRestsCount, nonRestCounter, this.startVerticalOffsetLikelihoods, this.endVerticalOffsetLikelihoods);
                ...
                if (this.useHorizontalOffsets &&
                    ...
                    me.horizontalRelativeTypes = [HorizontalRelativeType.NEXT_NOTE];
                    me.horizontalDomainOffsetTypes = [OffsetType.SCALE];
                    const horizontalOffsets = getItemFromArrayWithStartEndItems([-1, 0, 1], this.horizontalOffsets, nonRestsCount, nonRestCounter, this.startHorizontalOffsets, this.endHorizontalOffsets);
                    const horizontalLikelihoods = getItemFromArrayWithStartEndItems([1], this.horizontalLikelihoods, nonRestsCount, nonRestCounter, this.startHorizontalLikelihoods, this.endHorizontalLikelihoods);
