...
class ConstantHarmonyElement extends HarmonyElement {
    ...
    getChordRootIndexAndChromaticOffsetForAbsoluteNote(absoluteNote, maxCount) {
        ...
        const result = this.getScaleIndexAndChromaticOffsetForAbsoluteNoteStatic(absoluteNote, baseNote, increments);
    ...
    getScaleIndexAndChromaticOffsetForAbsoluteNote(absoluteNote) {
        return this.getScaleIndexAndChromaticOffsetForAbsoluteNoteStatic(absoluteNote, this.getBaseNote(), this.getScale());
    }
