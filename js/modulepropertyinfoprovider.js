class ModulePropertyInfoProvider {
    constructor(options) {
    ...
    addChangeListenerIfNecessary(sourceComponent, listenerComponent, sourcePropertyInfo, listenerPropertyInfo) {
    }
    registerComponent(component, propertyInfo) {
    ...
    unregisterComponent(component, propertyInfo) {
    ...
    addComponentChangeListener(component, object, propertyName) {
    ...
    removeComponentChangeListener(component, object, propertyName) {
    ...
    getHarmonyModifierConstructorTexts() {
        return [
    ...
    getHarmonyElementConstructorTexts() {
        return [
    ...
    createDefaultBooleanPropertyInfo(propName, caption, defaultValue) {
    ...
    createDefaultFloatPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultIntPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultStringPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultMidiNotePropertyInfo(propName, caption, defaultValue) {
        return this.createDefaultIntPropertyInfo(propName, caption, defaultValue);
    }
    createDefaultScaleIndexPropertyInfo(propName, caption, defaultValue) {
        return this.createDefaultIntPropertyInfo(propName, caption, defaultValue);
    }
    ...
    createDefaultRangePropertyInfo(propName, caption, defaultValue, dataType) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createDefaultFloatListPropertyInfo(propName, caption, defaultValue) {
        const info = new GuiPropertyInfo({
            propertyName: propName,
            propertyCaption: caption,
            propertyInfoProvider: this,
    ...
    createPositionUnitPropertyInfo(propName, caption, defaultValue) {
    ...
    createMotifElementPropertyInfos(obj, parentPropertyInfo, result) {
        ...
        if (obj instanceof ConstantMotifElement) {
            ...
            const info = this.createObjectListPropertyInfo("fillers", "Fillers", this.fillersUidInfo, [["FillerNote", "Filler"]
            ]);
    ...
    getGuiPropertyInfos(obj, parentPropertyInfo) {
        ...
        if (obj instanceof GenMusicModule) {
            ...
            result.addPropertyInfo(this.createObjectListPropertyInfo("zones", "Zones", this.webAudioSourceZonesUidInfo, [["WebAudioSourceZone", "Zone"]]));
        }
            ...
            result.addPropertyInfo(this.createIdReferencePropertyInfo("renderChannel", "Render channel", this.renderChannelsUidInfo));
            result.addPropertyInfo(this.createObjectPropertyInfo("instrument", "Instrument", this.sionInstrumentUidInfo, [["SionPresetInstrument", "Preset"]]));
            result.addPropertyInfo(this.createDefaultIntPropertyInfo("masterVolume", "Master volume", 64));
            let info = this.createObjectListPropertyInfo("effectSends", "Effect sends", this.sionEffectSendsUidInfo, [["SionEffectSend", "Effect send"]]);
            result.addPropertyInfo(info);
        }
            ...
            let info = this.createObjectListPropertyInfo("mappings", "Instrument mappings", this.sionInstrumentMapsUidInfo, [["SionInstrumentChannelMap", "Map"]]);
            result.addPropertyInfo(info);
            ...
            let info = this.createObjectListPropertyInfo("initialControllerMessages", "Initial controller messages", this.midiControllerMessagesUidInfo, [["InitialMidiControllerMessage", "Controller Message"]]);
            result.addPropertyInfo(info);
        }
            ...
            let info = this.createObjectListPropertyInfo("channelMaps", "Channel maps", this.midiChannelMapsUidInfo, [["MidiChannelMap", "Channel Map"]]);
            result.addPropertyInfo(info);
        }
            ...
            result.addPropertyInfo(this.createDefaultIntPropertyInfo("seed", "Seed", 12345));
            let info = this.createObjectListPropertyInfo("zones", "Split Zones", this.splitZonesUidInfo, [["SplitZone", "Split Zone"]]);
            result.addPropertyInfo(info);
        }
            ...
            let info = this.createObjectListPropertyInfo("references", "Sections", this.sectionReferencesUidInfo, [["SectionReference", "Section Reference"]]);
            result.addPropertyInfo(info);
        }
            ...
            if (obj instanceof ConstantVoiceLine) {
                ...
                let info = this.createObjectListPropertyInfo("lineElements", "Voice Elements", this.voiceElementsUidInfo, [["ConstantVoiceLineElement", "Simple"],
            ...
            if (obj instanceof PositionedRenderElement) {
                ...
                if (obj instanceof MotifRenderElement) {
                    ...
                    result.addPropertyInfo(this.createObjectListPropertyInfo("zones", "Zones", this.renderElementZonesUidInfo, [["HarmonyCountRenderElementZone", "Harmony Count Zone"]]));
                }
            ...
            if (obj instanceof PrimitiveRenderLine) {
                ...
                let info = this.createObjectListPropertyInfo("renderElements", "Render Elements", this.renderElementsUidInfo, this.getRenderElementConstructorTexts());
                result.addPropertyInfo(info);
            }
        }
            ...
            if (obj instanceof PrimitiveControlLine) {
                ...
                let info = this.createObjectListPropertyInfo("controlElements", "Control Elements", this.controlElementsUidInfo, [["CurveControlElement", "Curve Control"]]);
                result.addPropertyInfo(info);
            }
        }
            ...
            if (obj instanceof Section) {
                ...
                let info = this.createObjectListPropertyInfo("voiceLines", "Voice Lines", this.voiceLinesUidInfo, [["ConstantVoiceLine", "Simple Line"],
                ...
                let info = this.createObjectListPropertyInfo("modifiers", "Section Modifiers", this.sectionReferenceModifiersUidInfo, this.getSectionModifierConstructorTexts());
                result.addPropertyInfo(info);
            }
        }
            ...
            if (obj instanceof RandomShortenHarmonyModifier) {
                ...
                let info = this.createObjectListPropertyInfo("elements", "Elements", this.harmonyElementsUidInfo, this.getHarmonyElementConstructorTexts());
                result.addPropertyInfo(info);
            }
        }
            ...
            let info = this.createObjectListPropertyInfo("rythmElements", "Rythm Elements", this.rythmElementsUidInfo, [["NoteRythmElement", "Simple"], ["SequenceRythmElement", "Simple sequence"], ["SplitRythmElement", "Split"]]);
            result.addPropertyInfo(info);
        }
            ...
            if (obj instanceof NoteRythmElement) {
                ...
                result.addPropertyInfo(this.createObjectPropertyInfo("splitZoneCollection", "Split Zone Collection", this.splitZoneCollectionUidInfo, [["SplitZoneCollection", "Split Zone Collection"]]));
            }
        }
            ...
            if (obj instanceof PredefinedCurve) {
                ...
                result.addPropertyInfo(this.createObjectPropertyInfo("computation", "Computation", this.curveComputationsUidInfo, [["AddCurveComputation", "Add"],
